...
describe('HeaderComponent', () => {
  ...
  it('should display logo image', () => {
    ...
    expect(imgElement.nativeElement.src).toContain('task-management-logo.png');
    expect(imgElement.nativeElement.alt).toBe('A todo list');
  });

  it('should display subtitle paragraph', () => {
    fixture.detectChanges();
    const pElement = debugElement.query(By.css('p'));
    expect(pElement).toBeTruthy();
    expect(pElement.nativeElement.textContent.trim()).toBe('Enterprise-level task management without friction');
  });
  ...
  describe('Template Integration', () => {
    ...
    it('should have responsive design elements', () => {
      ...
      // Verify that the header has the expected structure for styling
      const imgElement = headerElement?.querySelector('img');
      const divElement = headerElement?.querySelector('div');
